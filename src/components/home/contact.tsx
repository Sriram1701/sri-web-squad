...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-8 sm:py-12 md:py-14 bg-[#030712] border-t border-slate-900 relative overflow-hidden text-white">
      ...
      <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-[radial-gradient(circle,rgba(37,99,235,0.08)_0%,transparent_70%)] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[radial-gradient(circle,rgba(59,130,246,0.08)_0%,transparent_70%)] pointer-events-none" />
